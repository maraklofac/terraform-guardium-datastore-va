...
# Aurora PostgreSQL VA Config Module - Main Configuration
...
resource "aws_iam_role" "lambda_role" {
  name = "${var.name_prefix}-aurora-postgres-va-config-lambda-role"
...
resource "aws_iam_policy" "lambda_policy" {
  name        = "${var.name_prefix}-aurora-postgres-va-config-lambda-policy"
  description = "Policy for Aurora PostgreSQL VA configuration Lambda function"
...
resource "aws_security_group" "lambda_sg" {
  name        = "${var.name_prefix}-aurora-postgres-va-config-lambda-sg"
  description = "Security group for Aurora PostgreSQL VA configuration Lambda function"
  vpc_id      = var.vpc_id
