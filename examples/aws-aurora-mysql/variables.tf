...
# AWS Aurora MySQL with VA Example - Variables
...
variable "name_prefix" {
  ...
  type        = string
  default     = "aurora-mysql-monitoring"
}
...
#------------------------------------------------------------------------------
variable "db_host" {
  description = "Cluster endpoint of the Aurora MySQL cluster"
  type        = string
}
...
variable "db_port" {
  description = "Port for Aurora MySQL cluster"
  type        = number
  default     = 3306
}
...
variable "db_security_group_id" {
  description = "Security group ID of the Aurora MySQL cluster"
  type        = string
}
...
variable "datasource_name" {
  ...
  type        = string
  default     = "aurora-mysql-va"
}

variable "datasource_description" {
  description = "Description of the datasource"
  type        = string
  default     = "Aurora MySQL data source onboarded via Terraform"
}
