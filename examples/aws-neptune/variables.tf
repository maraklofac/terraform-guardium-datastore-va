...
# AWS Neptune with VA Example - Variables
...
variable "neptune_security_group_id" {
  description = "Security group ID of the Neptune cluster (will add ingress rule to allow Lambda access)"
  type        = string
  default     = ""
}
...
variable "db_username" {
  description = "Username for the Neptune database (used for Guardium registration)"
  type        = string
  default     = "admin"
}

variable "db_password" {
  description = "Password for the Neptune database (used for Guardium registration)"
  type        = string
  sensitive   = true
}

variable "datasource_database" {
  description = "Database name (for Neptune, this is typically the graph name or can be left empty)"
  type        = string
  default     = ""
}
...
variable "datasource_description" {
  ...
  type        = string
  default     = "Neptune data source onboarded via Terraform"
}
